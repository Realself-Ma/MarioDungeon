    ...
    QWidget(parent)
{
    ...
    QFont fontPauseEvent("Microsoft YaHei",24,100);
    ...
    ReturnMainMenu=fac->CreateQPushButton(MenuWidget,200,200,120,30,"返回主菜单",button_style,fontLabel);
    Restart=fac->CreateQPushButton(MenuWidget,200,240,120,30,"重新开始",button_style,fontLabel);
    Continue=fac->CreateQPushButton(MenuWidget,200,280,120,30,"继续游戏",button_style,fontLabel);
}
